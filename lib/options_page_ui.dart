                                    ...
                                    if (selected)
                                      Positioned(
                                        ...
                                        child: Container(
                                          ...
                                          child: const Text('Seleccionado', style: TextStyle(color: Colors.white, fontSize: 10)),
                                        ),
                                      ),
                                  ],
                                ),
                  ...
                  children: [
                    Expanded(
                      child: ElevatedButton.icon(
                        style: ElevatedButton.styleFrom(padding: const EdgeInsets.symmetric(vertical: 14), backgroundColor: Colors.indigoAccent),
                        onPressed: () {
